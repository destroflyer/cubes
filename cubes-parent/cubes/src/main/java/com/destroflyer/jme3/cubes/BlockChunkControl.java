...
public class BlockChunkControl extends AbstractControl implements BitSerializable{
    ...
    public Block getBlock(Vector3Int location){
        ...
        return terrain.getBlock(location.add(blockLocation));
    }
    ...
    public boolean updateSpatial(){
        if(needsMeshUpdate){
            ...
            optimizedGeometry_Opaque.setMesh(terrain.getSettings().getMeshMerger().generateMesh(this, false));
            optimizedGeometry_Transparent.setMesh(terrain.getSettings().getMeshMerger().generateMesh(this, true));
    ...
    public boolean isBlockOnSurface(Vector3Int location){
        ...
        Vector3Int globalLocation = location.add(blockLocation);
        BlockChunkControl chunk = terrain.getChunk(globalLocation);
        return chunk.isBlockOnSurface(globalLocation.subtract(chunk.getBlockLocation()));
    }
